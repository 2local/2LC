      ...
      >
        <div className="innerContainer">
          <div className="d-flex align-items-center justify-content-between pl-4 pt-3 pr-4 pb-3">
            ...
            <div className="font-weight-bold balanceAmount">$137.17</div>
          ...
          <div className="d-flex align-items-center justify-content-between pl-4 pt-3 pr-4 pb-3 wallet">
            <span className="font-weight-bold addWallet">Add new wallet</span>
            <i
              class="far fa-plus-square ml-5 addSquare"
              onClick={() => setModal(4)}
            ></i>
          </div>
